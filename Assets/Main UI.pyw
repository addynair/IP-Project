...
def funcLogin():  #checks your usernames and passwords
    ...
    if result:
        ...
        ttk.Label(root1,
                  text='Guest Data',
                  font=('Segoe UI Variable Display', 15)).place(x=35, y=80)
        ...
        ttk.Label(root1,
                  ...
                  font=('Segoe UI Variable Display', 15)).place(x=35, y=240)
        ...
        ttk.Label(root1,
                  text="Payments",
                  font=("Segoe UI Variable Display", 15)).place(x=450, y=80)
